    ...
    private void spinnerStart() {
        cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                RelativeLayout.LayoutParams centeredLayoutParams = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
                centeredLayoutParams.setMargins(100,100,100,100);
